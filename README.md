...
| **SFT_ID-MAS** | `SaFD-00/qwen3-0.6b-math-gsm8k` | ID-MAS 방식 SFT 모델 |
...
```
SaFD-00/{model}-{domain}-{dataset}          # Self-Distillation
SaFD-00/{model}-{domain}-{dataset}-gpt52    # Cross-Model (GPT-5.2 Teacher)
```

**예시:**
- `SaFD-00/qwen3-0.6b-math-gsm8k` — Qwen3-0.6B, GSM8K 학습, Self-Distillation
- `SaFD-00/qwen3-4b-logical-reclor-gpt52` — Qwen3-4B, ReClor 학습, GPT-5.2 Teacher
