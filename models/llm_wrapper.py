...
class LLMWrapper:
    ...
    def __init__(self, config: dict = None):
        ...
        # Custom API endpoint 지원 (LLaMA-Factory 등)
    ...
    def generate(
        ...
        # max_tokens 파라미터 (LLaMA-Factory는 max_tokens, OpenAI는 max_completion_tokens)
        ...
        # OpenAI 전용 파라미터 (custom endpoint에서는 스킵)
    ...
    def generate_json(
        ...
        try:
            ...
            # LaTeX 등 유효하지 않은 이스케이프 시퀀스 수정 후 재시도
            try:
